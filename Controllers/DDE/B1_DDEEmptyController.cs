...
namespace WebAPI_1721030646.Controllers.DDE
{
    ...
    [ApiController]
    public class B1_DDEEmptyController : ControllerBase
    {
        private readonly EcommerceAddressContext _context;
        private readonly IMapper _mapper;
        public B1_DDEEmptyController(EcommerceAddressContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<ActionResult<IEnumerable<AddressDTO>>> GetAddressByID(int AddressID)
        {
            var Address = await _context.Addresses
